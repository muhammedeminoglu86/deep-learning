...
class LSTMModel(nn.Module):
    """LSTM Model for Turkish Lyrics Classification"""
    def __init__(self, vocab_size, embedding_dim=128, hidden_dim=256, num_layers=2, num_genres=6, max_length=100, dropout=0.3):
    ...
    def forward(self, lyrics):
        ...
        # Classification
        genre_logits = self.classifier(attended_output)
...
class LSTMTrainer:
    ...
    def train(self, num_epochs=20):
        """Model eğitimi"""
        print(f"LSTM model eğitimi başlıyor...")
        ...
        for epoch in range(num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                patience_counter = 0
                self.save_model(f"models/lstm/best_model.pth")
    ...
    def evaluate_final(self, predictions, targets):
        ...
        report = classification_report(targets, predictions, target_names=genre_names, output_dict=True)
    ...
    def plot_training_history(self):
        ...
        ax2.set_title('LSTM Model - Validation Accuracy')
        ...
        print("Training history plot kaydedildi: results/lstm_training_history.png")
